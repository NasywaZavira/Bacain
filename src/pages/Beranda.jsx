...
const Beranda = () => {
  ...
  return (
    <section className="w-full flex flex-col justify-center items-center md:items-start h-screen bg-gradient-to-b from-white via-white/80 to-orange-200 dark:bg-none dark:bg-gray-900 transition-all duration-300">
      ...
      {/* Footer */}
      <footer className="w-full text-center py-4 text-gray-700 dark:text-gray-500 absolute bottom-0 transition-colors">
        <p className="text-sm">
